...
#export PATH=$HOME/bin:/usr/local/bin:/Users/fth/.local/bin:$PATH
export PATH=$PATH:/Users/fth/.local/bin
export PATH=$PATH:/Users/fth/Library/Python/3.9/bin
...
_fzf_comprun() {
  ...
  case "$command" in
    ...
    ssh)          fzf "$@" --preview 'dig {}' ;;
    less)         fzf "$@" --preview 'bat --style=numbers --color=always --line-range :500 {}' ;;
    *)            fzf "$@" ;;
  esac
}
...
zstyle ':fzf-tab:complete:ls:*' fzf-preview 'exa -lah --icons --color=always $realpath'
zstyle ':fzf-tab:complete:exa:*' fzf-preview 'exa -1 --icons --color=always $realpath'
...
# zstyle ':fzf-tab:complete:less:*' fzf-preview 'exa -1 --icons --color=always $realpath'
# zstyle ':completion:*' fzf-preview 'exa -1 --color=always $realpath'
